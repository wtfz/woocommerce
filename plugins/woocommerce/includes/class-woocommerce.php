...
final class WooCommerce {
	...
	public function build_dependencies_notice() {
		...
		$message_one = __( 'You have installed a development version of WooCommerce which requires files to be built and minified. From the plugin directory, run <code>pnpm install</code> and then <code>pnpm exec turbo build --filter=woocommerce</code> to build and minify assets.', 'woocommerce' );
		$message_two = sprintf(
